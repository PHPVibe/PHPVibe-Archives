...
if (isset ($_POST['username'])){
    ...
    $from = $site_url; // $adminEmail is established in [ scripts/connect_to_mysql.php ]
    $subject = 'Complete Your ' . $site_url . ' Registration';
    //Begin HTML Email Message
    $message = "Hi $username,

   Complete this step to activate your login identity at $site_url

   Click the line below to activate when ready

   http://$site_url/activation.php?id=$id&sequence=$db_password
...
<meta name="Description" content="Register and join our video community" />
<meta name="Keywords" content="register, video, community" />
<meta name="rating" content="General" />
<title>Register at <?php echo $site_title; ?></title>
