...

{
...

	{
...

		{
			...
			$query = "update zu_ratings set liked = liked+1 where vid = '".$val."'";
...

		{
			...
			$query = "update zu_ratings set dislike = dislike+1 where vid = '".$val."'";
	...
	$result=dbquery("select * from zu_ratings where vid = '".$val."' ");
