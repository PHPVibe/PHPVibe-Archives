...
echo '<div class="msg-info">Video #'.$id.' was removed from featured.</div>';
}
} 
                        ...
                        <table class="table table-bordered table-checks">
						  ...
						  <?php foreach ($videos as $video) { ?>
                              <tr>
								 ...
								 <?php } else { ?>
								  <p><a href="<?php echo canonical();?>&unfeature=<?php echo $video->id;?>"><i class="icon-remove-sign" style="margin-right:5px;"></i><?php echo _lang("Unfeature video"); ?></a></p>
								 <?php } ?>
