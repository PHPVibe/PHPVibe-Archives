	...
	*/
	public function show_pages($pagi_url){
		...
		if($this->show_first==true){
			$output .= '<li> <a class="first" href="'.$pagi_url.'1">First</a><li>';
		}
		if($this->current>2){
			$output .= '<li><a class="previous" href="'.$pagi_url.$prev.'"><</a></li>';
		}
		...
		if($this->current<$this->page_numbers()){
			$output .= '<li><a class="nextpage" href="'.$pagi_url.$next.'">></a></li>';
		}
		if($this->show_last==true){
			$output .= '<li><a class="lastpage" href="'.$pagi_url.$this->page_numbers().'">Last</a></li>';
		}	
