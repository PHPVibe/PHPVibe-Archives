...
$.fn.MaxUpload = function( options ) {
    var settings = {
        ...
        'maxFileSize': -1,
        'maxFileCount': 1,
        'progressGIF': site_url + 'tpl/main/images/load.gif',
            ...
            this.realDiv =$( '<div/>', { 'class':'Maxuploader' } );
               ...
               this.fileField = $( '<input/>', { 'class':'file', 'name':'file',  'type':'file', 'multiple':'true'} );
                ...
                fform.append(this.realDiv);
                    ...
                    this.submit = $('<input/>', { 'type':'button', 'value':'Upload', 'class':$.browser.msie ? 'ib':'button '}).css({'width':'auto','position':'relative','padding':'6px 20px'});
