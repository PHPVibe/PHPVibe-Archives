...
if(!is_licensed()) {
echo "License key check with phpVibe server has failed. Please add the correct license key for domain ".get_domain(SITE_URL)." under vibe_config.php ";
die();
}	
ob_start();
...
$sql_queries = array();
				...
				if(is_file($sql_file))
				{
					...
					//echo "<pre>$query</pre>";
						$qt = str_replace("#db-prefix#",DB_PREFIX,$query);
						$db->query($qt);
					}
					}	
