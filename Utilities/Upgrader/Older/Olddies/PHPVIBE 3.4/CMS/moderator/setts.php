...
<span class="help-block" id="limit-text">Number of videos per page</span>						
	...
	<div class="controls">
	<input type="text" name="binpath" class=" span12" value="<?php echo get_option('binpath','/usr/bin/php5'); ?>" /> 
	<span class="help-block" id="limit-text">PHP Bin path for crons (conversion/scheduled tasks)</span>
	</div>
	</div>
