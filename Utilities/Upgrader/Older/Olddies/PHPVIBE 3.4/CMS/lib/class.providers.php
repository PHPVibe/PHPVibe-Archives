<?php
  ...
  class Vibe_Providers
  {
    ...
    ], primary : "flash",      file: "' . $file . '",         image: "' . $thumb . '", 		height: ' . $this->height . ',   repeat: "always",		aspectratio: "16:9",  autostart: "true",	width: "100%"';
...
return  $embed;	
      ...
      public function remotevideo($url)
      {
          ...
          $embedCode = '';
          if ($url) {
		  $embedCode = $this->_jwplayer ($url,$video->thumb,$this->height, thumb_fix(get_option('site-logo')));
           }
          return $embedCode;
      }
