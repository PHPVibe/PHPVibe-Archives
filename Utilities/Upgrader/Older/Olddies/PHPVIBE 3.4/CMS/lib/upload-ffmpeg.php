...
$db->query("INSERT INTO ".DB_PREFIX."videos (`pub`,`token`, `user_id`, `source`, `thumb`) VALUES ('".get_option('videos-initial')."','".$token."', '".user_id()."', '".$source."','".get_option('mediafolder')."/thumbs/xmp3.jpg')");
if($ext !== "mp3"){
/* It's mp4 -> Get thumbnail */
//Extract thumbnail
