...
$insertvideo = $db->query("INSERT INTO ".DB_PREFIX."homepage (`title`, `type`, `ident`, `querystring`, `total`, `ord`, `mtype` ) VALUES ('".toDb($_POST['title'])."', '2', '".toDb($_POST['ident'])."', '".toDb($_POST['queries'])."', '".toDb($_POST['number'])."', '1', '".toDb($_POST['type'])."')");		
}
