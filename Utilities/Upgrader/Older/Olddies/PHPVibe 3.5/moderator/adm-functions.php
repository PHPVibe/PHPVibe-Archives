...
<script type="text/javascript" src="'.admin_url().'editor/ckeditor/ckeditor.js"></script>
          ...
          <div class="sidebar-nav nav-collapse collapse themebgcolor">
            <div class="navbar-inner themebgcolor">
              ...
              <div class="accordion" id="main-accordion">
				...
				<div class="accordion-group">
                  <div class="accordion-heading">
                    <a class="accordion-toggle" href="'.admin_url('upsetts').'"><div class="menubg"></div><i class="icon-upload-alt"></i> <span>Uploads Config</span></a>
                  </div>
                </div>
				<div class="accordion-group">
                  <div class="accordion-heading">
                    <a class="accordion-toggle" href="'.admin_url('players').'"><div class="menubg"></div><i class="icon-play"></i> <span>Players Config</span></a>
                  </div>
                </div>
				<div class="accordion-group">
                  <div class="accordion-heading">
                    <a class="accordion-toggle" href="'.admin_url('ffmpeg').'"><div class="menubg"></div><i class="icon-facetime-video"></i> <span>Crons & FFMPEG</span></a>
                  </div>
                </div>
				<div class="accordion-group">
                  <div class="accordion-heading">
                ...
                <div class="accordion-group">
                  <div class="accordion-heading">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#main-accordion" href="#collapse0"><div class="menubg"></div><i class="icon-list"></i> <span>Media</span></a>
                  </div>
                  <div id="collapse0" class="accordion-body '.add_active('images,music,videos,unvideos,videos,add-video,add-video,add-by-iframe').' collapse">
                    <div class="accordion-inner">
                      ...
                      <a class="accordion-toggle green-leftstripe" href="'.admin_url('images').'"><span>Images manager</span></a>
					  <a class="accordion-toggle green-leftstripe" href="'.admin_url('music').'"><span>Music manager</span></a>
					  <a class="accordion-toggle green-leftstripe" href="'.admin_url('unvideos').'"><span>Unpublished Media</span></a>
					  <a class="accordion-toggle green-leftstripe" href="'.admin_url('videos').'&sort=featured"><span>Featured Media</span></a>
                      <a class="accordion-toggle green-leftstripe" href="'.admin_url('add-video').'"><span>Add Media</span></a>
            		  <a class="accordion-toggle green-leftstripe" href="'.admin_url('add-by-iframe').'"><span>Submit embed code</span></a>
					</div>
                  </div>
                </div>
                <div class="accordion-group">
                ...
                <div class="accordion-group">
                  ...
                  <div id="collapse4" class="accordion-body '.add_active('users').' collapse">
                    <div class="accordion-inner">
					<a class="accordion-toggle" href="'.admin_url('create-user').'"><span>Create user</span></a>
				...
				<div class="accordion-group">
                  ...
                  <div id="collapse110" class="accordion-body '.add_active('pch,create-pch,edit-pch,posts,create-post,edit-post').' collapse">
                    <div class="accordion-inner">
				    <a class="accordion-toggle" href="'.admin_url('pch').'"><span>Categories</span></a> 
                    <a class="accordion-toggle" href="'.admin_url('posts').'"><span>Articles</span></a> 
                    <a class="accordion-toggle" href="'.admin_url('create-post').'"><span>New Article</span></a> 
                    <a class="accordion-toggle" href="'.admin_url('create-pch').'"><span>New Category</span></a> 					  
                   </div>
                  </div>
                </div> 
				 <div class="accordion-group">
                  ...
                  <div id="collapse11" class="accordion-body '.add_active('pages,create-page, edit-page').' collapse">
                    ...
                    <a class="accordion-toggle" href="'.admin_url('pages').'"><span>List pages</span></a> 
                      <a class="accordion-toggle" href="'.admin_url('create-page').'"><span>Create</span></a>             
                   </div>
                  </div>
                </div> 
				<div class="accordion-group">
                  ...
                  <div id="collapse12" class="accordion-body '.add_active('ads,create-ad, create-viad').' collapse">
                    <div class="accordion-inner">
				
                    <a class="accordion-toggle" href="'.admin_url('ads').'"><span>My Ads</span></a> 
                      <a class="accordion-toggle" href="'.admin_url('create-ad').'"><span>Create ad</span></a>
