...
<div class="row-fluid">
<div class="span6">
<input type="text" name="Tw_Key" class="span12" value="<?php echo get_option('Tw_Key'); ?>"><span class="help-block">Twitter app <strong>Consumer key</strong> </span>
</div>
<div class="span6">
<input type="text" name="Tw_Secret" class="span12" value="<?php echo get_option('Tw_Secret'); ?>"><span class="help-block align-center"> <strong>Consumer secret</strong></span>
</div>
</div>
</div>
</div>
