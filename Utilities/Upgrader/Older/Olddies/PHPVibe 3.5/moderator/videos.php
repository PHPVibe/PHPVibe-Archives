...
$videos = $db->get_results("select id,title,thumb, views, liked,featured, duration from ".DB_PREFIX."videos where pub > 0 and featured > 0 ORDER BY ".DB_PREFIX."videos.id DESC ".this_limit()."");
                        ...
                        <table class="table table-bordered table-checks">
						  ...
						  <?php foreach ($videos as $video) { ?>
                              <tr>
								  ...
								  <p><a href="<?php echo canonical(); ?>&feature-video=<?php echo $video->id;?>"><i class="icon-star" style="margin-right:5px;"></i><?php echo _lang("Feature video"); ?></a></p>
								 <?php } else { ?>
								  <p><a href="<?php echo canonical(); ?>&unfeature-video=<?php echo $video->id;?>"><i class="icon-remove-sign" style="margin-right:5px;"></i><?php echo _lang("Unfeature video"); ?></a></p>
								 <?php } ?>
