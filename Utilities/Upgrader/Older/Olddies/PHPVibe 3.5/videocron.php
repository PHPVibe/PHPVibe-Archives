...
$db->query("UPDATE  ".DB_PREFIX."videos SET source='".$source."' WHERE id = '".intval($cron->id)."'");
//Extract thumbnail
...
shell_exec ( $imgout);
$db->query("UPDATE  ".DB_PREFIX."videos SET thumb='".$thumb."' WHERE id = '".intval($cron->id)."'");
//Extract Duration
...
$db->query("UPDATE  ".DB_PREFIX."videos SET pub = '".intval(get_option('videos-initial'))."'  WHERE id = '".intval($cron->id)."'");
