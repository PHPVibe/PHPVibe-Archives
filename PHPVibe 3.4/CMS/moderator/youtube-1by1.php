...
$pagi_url = admin_url("youtube-1by1").'&action=search&key='.$importer['q'].'&categ='.$importer['categ'].'&orderby='.$importer['orderby'].'&safeSearch='.$importer['safeSearch'].'&lr='.$importer['lr'];
...
$nbTotal=$videosData['stats']['totalResults'];
if($nbTotal==0) { $nbTotal = count($videosData['videos']);	}
$pagi_url = admin_url("youtube-1by1").'&action=feed&feed_id='.$importer['feed_id'].'&time='.$importer['time'].'&categ='.$importer['categ'].'&safeSearch='.$importer['safeSearch'].'&lr='.$importer['lr'];
$pagi_url .= '&auto='.$importer['auto'].'&allowduplicates='.$importer['allowduplicates'].'&sleeppush='.$importer['sleeppush'].'&sleepvideos='.$importer['sleepvideos'].'&endpage='.$importer['endpage'].'&p=';
...
<i>Note: You need to manually select the videos you wish to import. </i>
