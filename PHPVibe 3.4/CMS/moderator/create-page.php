...
$db->query("INSERT INTO ".DB_PREFIX."pages (`date`, `menu`, `pic`, `title`, `content`, `tags`)
 VALUES (now(),'".intval($_POST['menu'])."', '".$picture."', '".$db->escape($_POST['play-name'])."', '".$db->escape($_POST['content'])."', '".$db->escape($_POST['tags'])."')");
...
<div class="controls">
<textarea rows="5" cols="5" name="content" class="html5edit span12" style="word-wrap: break-word; resize: horizontal; height: 88px;"></textarea>					
</div>	
</div>
<div class="control-group">
