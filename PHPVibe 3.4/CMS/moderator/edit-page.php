...
<div class="controls">
<textarea rows="5" cols="5" name="content" class="html5edit span12" style="word-wrap: break-word; resize: horizontal; height: 88px;"><?php echo _html($page->content); ?></textarea>					
</div>	
</div>
<div class="control-group">
