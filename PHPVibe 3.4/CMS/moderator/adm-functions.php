...
<head>
	...
	<link rel="stylesheet" href="'.admin_url().'editor/bootstrap-wysihtml5.css"/>
...
<script type="text/javascript" src="'.admin_url().'editor/lib/js/wysihtml5-0.3.0.min.js"></script>
<script type="text/javascript" src="'.admin_url().'editor/bootstrap-wysihtml5.js"></script>
          ...
          <div class="sidebar-nav nav-collapse collapse themebgcolor">
            <div class="navbar-inner themebgcolor">
              ...
              <div class="accordion" id="main-accordion">
				...
				<div class="accordion-group">
                  <div class="accordion-heading">
                    <a class="accordion-toggle" href="'.admin_url('ffmpeg').'"><div class="menubg"></div><i class="icon-facetime-video"></i> <span>FFMPEG Config</span></a>
                  </div>
                </div>
				<div class="accordion-group">
                  <div class="accordion-heading">
                ...
                <div class="accordion-group">
				 ...
				 <div class="accordion-group">
                  <div class="accordion-heading">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#main-accordion" href="#collapse11"><div class="menubg "></div><i class="icon-user"></i> <span>Pages</span></a>
                  </div>
				...
				<div class="accordion-group">
                  <div class="accordion-heading">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#main-accordion" href="#collapse12"><div class="menubg "></div><i class="icon-copy"></i> <span>Ads</span></a>
                  </div>
