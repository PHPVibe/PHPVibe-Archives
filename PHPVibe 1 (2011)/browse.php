...
$head_title = array();
$head_desc = array();
$head_title[] = 'Recent Videos. Page '.$pn.' of '.$lastPage; 
$head_desc[] = 'Showing the most recent video. Curent Page it\'s '.$pn; 
...
<div class="col col9">
  <div class="col-bkg clearfix">
    <h1><?php echo __("The most recent videos");?></h1>

<div class="vibe_contain">
 <ul>
<?php 
$limit = 'LIMIT ' .($pn - 1) * $BrowsePerPage .',' .$BrowsePerPage; 
 $sql = dbquery("SELECT * FROM videos WHERE views > 1 ORDER BY id DESC $limit");
...
<?php
   ...
   $url = $config->site->url.'browse/page-';
