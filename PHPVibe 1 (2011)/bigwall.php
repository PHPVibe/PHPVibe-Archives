...
$AE = new AutoEmbed();
$sql = dbquery("SELECT msg_id FROM user_wall"); 
...
<div class="col col9">
  <div class="col-bkg clearfix">
    <h1><?php echo __("Recent user statuses");?></h1>
<div id="wall" class="facebookWall">

<?php
$limit = 'LIMIT ' .($pn - 1) * $BrowsePerPage .',' .$BrowsePerPage; 
$result=mysql_query("select * from user_wall order by msg_id desc $limit");
...
<?php
   ...
   $url = $config->site->url.'bigwall.php?pn=';
