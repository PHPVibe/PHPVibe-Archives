...
$sql = dbquery("SELECT id FROM videos where liked > 0 ORDER BY id DESC"); 
...
$head_title = array();
$head_desc = array();
$head_title[] = 'Most LIKED Videos. Page '.$pn.' of '.$lastPage; 
$head_desc[] = 'Showing the most liked videos. Curent Page it\'s '.$pn; 
include_once("tpl/php/global_header.php");
?>
<div class="clearfix" id="main-content">
<div class="col col9">
  <div class="col-bkg clearfix">
    <h1><?php echo __("The most liked videos");?></h1>

<div class="vibe_contain">
 <ul>
<?php 
$limit = 'LIMIT ' .($pn - 1) * $BrowsePerPage .',' .$BrowsePerPage; 
 $sql = dbquery("SELECT * FROM videos where liked > 0 ORDER BY liked DESC $limit");
  ...
  $string .='<li>
                        	<div class="vibekeep">
                            	<a href="'.$new_seo_url.'"><img src="http://i4.ytimg.com/vi/'.$new_yt.'/default.jpg" width="147" height="99" alt="" />
									...
									<span class="iliked">'.$new_liked.' '.__("likes").'</span>
                                </a>
...
<?php
   ...
   $url = $config->site->url.'liked/page-';
