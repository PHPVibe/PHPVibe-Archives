...
$config_data['licence']['checked'] 		= (integer) !empty($config_ini['licence.checked']) ? $config_ini['licence.checked'] : null;
...
$config_data['core']['version'] 			= (string) '1.3';
...
$config_data['instance']['version'] 		= (string) 'Basic';
