...
$fads .= "
  ...
  $(cpJP).jPlayer('pause');
  $('.mediaPlayer').append(\"<div id='bigAd' class='screenAd'><div class='innerAd'>".$pread['jad_body']." <a class='bigadclose' href='javascript:void(0)'>"._lang('Skip this and play')."</a></div></div>\");
...
$fads .= "
  ...
  $(cpJP).jPlayer('pause');
  $('.mediaPlayer').append(\"<div id='bigAd' class='screenAd'><div class='innerAd'>".$postad['jad_body']." <a class='bigadclose' href='javascript:void(0)'>"._lang('Restart the video')."</a></div></div>\");
  $('.bigadclose').click(function(){  $(cpJP).jPlayer('play'); });
...
$fads .= "
 if (currentTime == ".$an["jad_start"]."){
		if($('#PL".$an["jad_id"]."').length < 1){
		//$(\"div.plAd\").remove();
            $(\".Player\").append(\"<div id='PL".$an["jad_id"]."' class='plAd ".$an["jad_pos"]."'>".$an["jad_body"]."<a class='plclose' href='javascript:void(0)'></a>\"); 
			 $(\".plclose\").click(function(){  	$(\"div.plAd\").remove();   });
			 
        }
		}
";
if(intval($an["jad_end"]) > 0) {
$fads .=  'setTimeout(function(){$("#PL'.$an["jad_id"].'").remove();}, '.$an["jad_end"].'000);';
}
...
$fads .= "
 if (currentTime == ".$an["jad_start"]."){
		if($('#BD".$an["jad_id"]."').length < 1){
		$(\"div.bAd\").remove();
            $(\".Player\").append(\"<div id='BD".$an["jad_id"]."' class='bAd ".$box_render[intval($an["jad_box"])]."'><div class='innerAd'>".$an["jad_body"]."<a class='adclose' href='javascript:void(0)'></a></div</div>\"); 
			 $(\".adclose\").click(function(){  	$(\"div.bAd\").remove();   });
        }
...
";
if(intval($an["jad_end"]) > 0) {
$fads .=  'setTimeout(function(){$("#BD'.$an["jad_id"].'").remove();}, '.$an["jad_end"].'000);';
}
}
