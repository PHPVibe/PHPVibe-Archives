...
$upd = json_decode(getpb("http://store.phprevolution.com/api"), true);	
?>
<div class="panel-heading">Updates <a href="http://store.phprevolution.com" target="_blank" class="pull-right pd-l-sm pd-r-sm">View more</a></div>
<div class="scroll-items">
<ul class="list-group">
<li class="list-group-item">
<div class="show no-margin pd-t-xs"> <a href="http://store.phprevolution.com/buy?id=22" target="_blank"><?php echo _html($upd["cms"]["release"]); ?></a> <small class="pull-right">v<?php echo $upd["cms"]["version"]; ?></small></div>
<small class="text-muted">Current subversion is <?php echo $upd["cms"]["suv"]; ?></small>
</li>
 <?php foreach ($upd["latest"] as $recent) {
$thumb = "http://store.phprevolution.com/".stripslashes($recent["thumb"]);
 ?>
<li class="list-group-item">
<span class="pull-left mg-t-xs mg-r-md">
<img src="<?php echo thumb_fix($thumb); ?>" class="avatar avatar-sm" alt="">
</span>
<div class="show no-margin pd-t-xs"> <a href="http://store.phprevolution.com/buy?id=<?php echo $recent["id"]; ?>" target="_blank"><?php echo _html($recent["name"]); ?></a> <small class="pull-right"><?php echo $recent["buys"]; ?> sales</small></div>
</li>
<?php } ?>
</ul>
