...
require_once("includes/functions.php");
    ...
    $sql = dbquery("UPDATE myMembers SET email_activated='1' WHERE id='$id' AND password='$hashpass'"); 

    $sql_doublecheck = dbquery("SELECT * FROM myMembers WHERE id='$id' AND password='$hashpass' AND email_activated='1'"); 
