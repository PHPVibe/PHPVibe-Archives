...
if ($_POST['parse_var'] == "pic"){
	...
	if ($_FILES['fileField']['tmp_name'] != "") { 
            $maxfilesize = 612000; // 51200 bytes equals 50kb
...
if ($_POST['parse_var'] == "location"){
	...
	$sqlUpdate = dbquery("UPDATE myMembers SET firstname='$firstname', lastname='$lastname', country='$country', state='$state', city='$city' WHERE id='$id' LIMIT 1");
    if ($sqlUpdate){
...
if ($_POST['parse_var'] == "links"){
    ...
    $sqlUpdate = dbquery("UPDATE myMembers SET website='$website', youtube='$youtube', facebook='$facebook', twitter='$twitter' WHERE id='$id' LIMIT 1");
	if ($sqlUpdate){
...
if ($_POST['parse_var'] == "bio"){
    ...
    $bio_body = nl2br(htmlspecialchars($bio_body));
	 ...
	 $sqlUpdate = dbquery("UPDATE myMembers SET bio_body='$bio_body' WHERE id='$id' LIMIT 1");
     if ($sqlUpdate){
...
$sql_default = dbquery("SELECT * FROM myMembers WHERE id='$id'");
        ...
        <form action="edit_profile.php" method="post" enctype="multipart/form-data">
          <tr>
            <td width="602"><table width="100%" border="0" align="center">
              ...
              <tr>
                <td width="34%"><input name="firstname" type="text" class="formFields" id="firstname" value="<?php echo $firstname; ?>" style="width:99%" maxlength="32" /></td>
                <td width="33%"><input name="lastname" type="text" class="formFields" id="lastname" value="<?php echo $lastname; ?>" style="width:99%" maxlength="32" /></td>
                <td width="33%">&nbsp;</td>
              </tr>
            </table>
              <table width="100%" border="0" align="center">
              ...
              <table width="100%" border="0" align="center">
                <tr>
                  ...
                  <td width="33%"><input name="state" type="text" class="formFields" id="state" value="<?php echo $state; ?>" style="width:99%" maxlength="32" /></td>
                  <td width="33%"><input name="city" type="text" class="formFields" id="city" value="<?php echo $city; ?>" style="width:99%" maxlength="32" /></td>
                </tr>
            </table></td>
