...
var ZU = new Class({
	...
	loadVideo: function (B) {
		...
		var A = "http://www.youtube.com/v/" + B.vidId + "&enablejsapi=1&playerapiid=ZU_videoPlayer&rel=" + this.options.playerConfig.showRelated + "&showsearch=" + this.options.playerConfig.showSearch + "&showinfo=" + this.options.playerConfig.showInfo;
...
function onYouTubePlayerReady() {
	var A = document.getElementById("ZU_videoPlayer");
	A.addEventListener("onStateChange", "ZUplayer.changeState");
	ZUplayer.swfObj = A
}
window.addEvent("load", function () {
	this.ZUplayer = new ZU({
		videoContainer: "ZU_playback",
		playlist: "ZU_playlist",
		videoSize: {
			width: 617,
			height: 500
		},
