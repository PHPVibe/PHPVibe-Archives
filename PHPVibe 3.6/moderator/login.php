...
<div class="row-fluid">
<div class="span6">
<input type="text" name="Tw_Token" class="span12" value="<?php echo get_option('Tw_Token'); ?>"><span class="help-block align-center"> <strong>Access token</strong></span>
</div>
<div class="span6">
<input type="text" name="Tw_Tosecret" class="span12" value="<?php echo get_option('Tw_Tosecret'); ?>"><span class="help-block align-center"> <strong>Access token secret</strong></span>
</div>
</div>
</div>
</div>
