...
//Player support
//JwPlayer
if((get_option('remote-player',1) == 1) || (get_option('choosen-player',1) == 1))	{					 
...
if (typeof jQuery == \'undefined\') {
 document.write(\'<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"><\/script>\');
}
</script>
'.players_js();
 echo '</head>
