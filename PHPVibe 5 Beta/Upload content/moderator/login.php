...
<div class="col-md-4">
<input type="text" name="SECRETSALT" class="col-md-12" value="<?php echo get_option('SECRETSALT'); ?>"><span class="help-block align-center"> Secret encryption <strong>salt</strong> (6-8 char)</span>
</div>
<div class="col-md-4">
