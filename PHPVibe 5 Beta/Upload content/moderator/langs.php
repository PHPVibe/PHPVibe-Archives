...
<form class="form-horizontal styled" action="<?php echo admin_url('langs');?>&p=<?php echo this_page();?>" enctype="multipart/form-data" method="post">
 <div class="form-group form-material">
	...
	<span class="help-block" id="limit-text"><code style="color:red">Code only</code>. Only add the language code. When switching to a language from this list the <?php echo tpl();?>styles/css/rtl.css will be loaded. By default this is <code>empty</code> but we will be building it in the client's forums with everybody's help. </span>
	</div>
	<div class="form-group form-material">
