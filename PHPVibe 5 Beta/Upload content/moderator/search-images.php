...
?>
<div class="row">
<h3 style="margin-bottom:20px;"> Images for <?php echo $key; ?> 
<a class="btn btn-round btn-primary btn-pill-right pull-right" href="<?php echo str_replace('sk=search-images','sk=search-videos',canonical());?>">Videos</a>
