...
<div class="col-md-offset-2 col-md-6 col-xs-12"> 
	...
	<div class="controls">
	<label class="radio inline"><input type="radio" name="offline" class="styled" value="1" <?php if(get_option('site-offline', 0) == 1 ) { echo "checked"; } ?>>On</label>
	<label class="radio inline"><input type="radio" name="offline" class="styled" value="0" <?php if(get_option('site-offline', 0) <> 1 ) { echo "checked"; } ?>>Off</label>
	</div>
	</div>
	</div>
</div>
