...
?>
<div class="row">
<h3 style="margin-bottom:20px;"> Videos for <?php echo $key; ?> 
<a class="btn btn-round btn-primary btn-pill-right pull-right" href="<?php echo str_replace('sk=search-videos','sk=search-images',canonical());?>">Images</a>
