<?php
	...
	class FeedRSS {
		...
		function Output() {
			...
			//RSS header:
			$out .= "<rss version=\"2.0\" xmlns:content=\"http://purl.org/rss/1.0/modules/content/\" xmlns:wfw=\"http://wellformedweb.org/CommentAPI/\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:atom=\"http://www.w3.org/2005/Atom\" xmlns:sy=\"http://purl.org/rss/1.0/modules/syndication/\" xmlns:slash=\"http://purl.org/rss/1.0/modules/slash/\">";
			$out .= "\n";
			$out .= "\t".'<channel>';
			$out .= "\n";
			...
			for($i=0; $i < count($this->articles); $i++) {
				...
				$out .= "\t\t\t<link>http://". $this->articles[$i]['link'] ."</link>\n";
				$out .= "\t\t\t<guid isPermaLink=\"true\">http://". $this->articles[$i]['guid'] ."</guid>\n";
				...
				$out .= "\t\t\t<category domain=\"http://". $this->articles[$i]['categoryDomain'] ."\"><![CDATA[". $this->articles[$i]['category'] ."]]></category>\n";
