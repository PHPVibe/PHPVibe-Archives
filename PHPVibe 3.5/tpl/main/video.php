...
<div id="video-content" class="span77" style="min-height:<?php echo $height;?>px">
<?php echo _ad('1');?>
<div id="video-wrapper">
<div class="video-player pull-left player-in-list" style="min-height:<?php echo $height;?>px">
<?php echo $embedvideo; ?>
...
<li> <i class="icon-info-sign"></i><?php echo _("Uploaded"). ' '.time_ago($video->date); ?><span class="small-text"><?php echo makeLn(_html($video->description));?></span></li>
