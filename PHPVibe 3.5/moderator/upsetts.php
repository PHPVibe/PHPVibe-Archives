...
<div class="control-group">
	<label class="control-label"><i class="icon-download-alt"></i>Show sharing menu to</label>
	<div class="controls">
...
<div class="control-group">
	<label class="control-label"><i class="icon-download-alt"></i>Upload Rule</label>
	<div class="controls">
...
<div class="control-group">
	<label class="control-label"><i class="icon-youtube"></i>Embedding Rule</label>
	<div class="controls">
	...
	<div class="control-group">
	<label class="control-label"><i class="icon-music"></i>Music (mp3) Rule</label>
	<div class="controls">
	...
	<div class="control-group">
	<label class="control-label"><i class="icon-picture"></i>Image Sharing Rule</label>
	<div class="controls">
