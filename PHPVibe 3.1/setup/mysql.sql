...
ALTER TABLE  `user_wall` ADD  `picture` LONGTEXT NOT NULL AFTER  `message`;
ALTER TABLE  `channels` ADD  `child_of` INT NULL DEFAULT NULL AFTER  `cat_id`;
ALTER TABLE  `homepage` ADD  `order` INT( 11 ) NOT NULL AFTER  `id`;
