...
$.fn.MaxUpload = function( options ) {
    ...
    var internal = {
        ...
        render: function ( element ) {
            ...
            fform = $('<form/>');
            this.realDiv =$( '<div/>', { 'class':'MaxUploader MUgreen' } );
               ...
               this.fileField = $( '<input/>', { 'class':'file', 'name':'file',  'type':'file', 'multiple':'true'} );
				this.fileButton = $( '<input/>', { 'class':'MUbutton', 'name':'file',  'type':'button',  'value':'Browse...'} );
                ...
                fform.append(this.realDiv);
                    ...
                    this.submit = $('<input/>', { 'type':'button', 'value':'Upload', 'class':$.browser.msie ? 'ib':'buttonS bBlue '}).css({'width':'auto','position':'relative','padding':'6px 20px'});
