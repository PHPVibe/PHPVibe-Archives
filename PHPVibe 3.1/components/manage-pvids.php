...
<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
 <thead>
 <tr>
<td width="90px">Thumb</td>
<td>Title</a></td>
<td width="190px">Options</td>		</tr>
</thead>
 <tbody>';
while($video = mysql_fetch_array($data)){
$full_title = stripslashes(str_replace("\"", "",$video["title"]));			
$url = $site_url.'video/'.$video["video_id"].'/'.seo_clean_url($full_title) .'/';
$content.= '
<tr>		
<td>
<a class=\'repeat\' href="'. $url.'" target="_blank"><img src=\''. $video["thumb"].'\' style="width:90px;height:90px;"></a>
</td>
<td>'. $full_title.'</td>';
$content.= '
<td>
<div class="button-group">
<a href="'.$site_url.'playmanager/&edit='.$p_id.'&delete='.$video["id"].'" title="Are you sure you want to delete this video from playlist?" class="button"><span class="icon icon56"></span><span class="label">Remove video</span></a>
</div>
 </td>		
</tr>
';	
