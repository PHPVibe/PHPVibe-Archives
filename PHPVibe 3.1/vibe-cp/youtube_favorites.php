...
$pagi_url = $admin_link.'youtube_favorites.php?&s='.$searched_term.'&channel='.$channel.'&page=';
...
$criteria['username'] = $searched_term;
$criteria['start-index'] = $startIndex;
$criteria['max-results'] = $nb_display;

	$v1 = new Youtube_class();
	$url = $v1->getYoutubeUserFavoriteVideos($criteria);
