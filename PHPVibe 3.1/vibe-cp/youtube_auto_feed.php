...
$pageNumber = MK_Request::getQuery('p', 1);	
...
$pagi_url = $admin_link.'youtube_auto_feed.php?list='.$feed.'&channel='.$channel.'&time='.$time.'&p=';
...
<p> <span>'.$videosData['videos'][$i]['title'].' <br /><br />'.$this_ms .'</span></a></
</li>
';
}	?>  	
 </ul>
