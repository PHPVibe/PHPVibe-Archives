...
<link rel="stylesheet" href="<?php echo $config->site->url; ?>components/lightbox/themes/default/jquery.lightbox.css"/>
 ...
 <script type="text/javascript" src="<?php echo admin_panel(); ?>js/jquery.dataTables.js"></script>  
 <script type="text/javascript" src="<?php echo admin_panel(); ?>js/tablesort.min.js"></script>
<script type="text/javascript" src="<?php echo admin_panel(); ?>js/resizable.min.js"></script>
...
<div class="menu">
	<ul>
	  <li class="current">	  <a target="_blank" href="<?php echo $site_url; ?>"><< Preview site</a>	  </li>
	      <li class="single-link"> <a href="<?php echo admin_panel(); ?>">Administration</a>	</li>	
      <li class="single-link"> <a href="<?php echo admin_panel(); ?>settings.php">Settings</a>	</li>	
	...
	<div id="sidebar">
<ul id="nav">
			<li ><a href="<?php echo admin_panel(); ?>settings.php" class="collapse"><img src="img/icons/add.png" alt="" />Configuration</a>
			<ul>
			<li><a href="<?php echo admin_panel(); ?>settings.php">Main Settings</a></li>
			<li><a href="<?php echo admin_panel(); ?>set_seo.php">SEO & Misc</a></li>
			</ul>
			</li>
			<li><a href="<?php echo admin_panel(); ?>change_images.php"><img src="img/icons/imagesList.png" alt="" />Images path</a></li>
			...
			<ul>
			       	<li><a href="<?php echo admin_panel(); ?>videos.php">Browse videos</a></li>
						<li><a href="<?php echo admin_panel(); ?>videos-grid.php">Manage videos</a></li>
					<li><a href="<?php echo admin_panel(); ?>featured.php">Featured videos</a></li>
					<li><a href="<?php echo admin_panel(); ?>submit.php">Add video by link</a></li>
					<li><a href="<?php echo admin_panel(); ?>submit-iframe.php">Add video by code</a></li>
					
				</ul>			
			</li>
			<li><a href="#" class="collapse"><img src="img/icons/transfer.png" alt="" />Youtube import</a>			
			<ul>
				<li><a href="<?php echo admin_panel(); ?>youtube1by1.php">Youtube 1 by 1 Import</a></li>
					<li><a href="<?php echo admin_panel(); ?>youtube.php">Youtube Auto Import</a></li>
			</ul>			
			</li>
			...
			<li><a href="<?php echo admin_panel(); ?>spam_users.php"><img src="img/icons/alert.png" alt="" />Spam Users</a></li>
		</ul>
