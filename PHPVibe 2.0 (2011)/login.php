...
if($user->isAuthorized()){
	...
	else
	{
		...
		$content = '<h2 class="narrow">Login</h2>';
		$content .= '<p class="narrow">Please enter your email address and password. If you can\'t remember your password then use the <a href="forgot-pass.php">forgotten password</a> form.</p>';
		if($form->isSuccessful()){
