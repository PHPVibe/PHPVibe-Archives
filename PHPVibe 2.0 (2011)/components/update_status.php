<?php
include("../phpvibe.php");
include "embed/AutoEmbed.class.php";
$AE = new AutoEmbed();
...
echo '</div>
<p class="meta">'.$user_time.' &nbsp; <span class="delete_button"><a href="#" onClick=";return false;" id="'.$id.'" class="delete_update"> DELETE STATUS</a></span></p>
