...
<p>Current subversion is <?php echo $upd["cms"]["suv"]; ?></p>
<p>Your subversion is <?php echo get_option('phpvibesub','12'); ?></p>
<p><?php if(get_option('phpvibesub','12') < $upd["cms"]["suv"]) { echo "<strong class=\"redText\">Your release is older.</strong>";} else {echo "<strong class=\"greenText\">You are up to day!</strong>";} ?></p>
</li>
