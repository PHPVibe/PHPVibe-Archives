<?php class Youtube_class {
	...
	function getYoutubeVideosByPlaylist($criteria) {
		$category = $criteria['category'];
		$startIndex = $criteria['start-index'];
		$maxResults = $criteria['max-results'];
		
		$url = 'http://gdata.youtube.com/feeds/api/playlists/'.$category.'?v=2';
...
$video["path"] = 'https://www.youtube.com/watch?v='.$video["videoid"];
