...
<link rel="stylesheet" id="lane-css"  href="//fonts.googleapis.com/css?family=Lato&#038;ver=4.0" type="text/css" media="all" />
'.extra_css().'
...
<a id="" href="'.site_url().share.'" class="btn btn-default btn-small " title="'._lang('Upload video').'">	
