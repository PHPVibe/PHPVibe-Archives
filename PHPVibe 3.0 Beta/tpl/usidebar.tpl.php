<!-- USER's SIDEBAR -->
   ...
   <ul class="side-menu">
		...
		<a href="#"><span class="m-icon"><img src="<?php echo w_icons("admin_user");?>"/></span><span class="menu-item"><?php if( $name = $user_profile->getName() ) 	{ echo $name; } else { echo $user_profile->getDisplayName(); } ?></span></a>
			<ul class="acitem">
   <?php if(!$is_follower && !is_owner($user_profile->getId())){
			...
			echo "<li><a href=\"".$site_url."videos-by/".$user_profile->getId()."\"><span class=\"m-icon\"><img src=\"".w_icons("hd")."\"/></span><span class=\"menu-item\">".$lang['videos']."<span></a></li>";
			echo "<li><a href=\"".$site_url."likes/".$user_profile->getId()."\"><span class=\"m-icon\"><img src=\"".w_icons("facebook_like")."\"/></span><span class=\"menu-item\">".$lang['likes']."<span></a></li>";
...
if (mysql_num_rows($playlist_result) > 0) { ?>
		...
		<li class="expand">
		<a href="#"><span class="m-icon"><img src="<?php echo w_icons("frames");?>"/></span><span class="menu-item">Playlists</span></a>
		<ul class="acitem">
<?php
$p_f = 1;
...
if (mysql_num_rows($folow_result) > 0) { ?>	
		...
		<li class="expand">
		<a href="#" class="active"><span class="m-icon"><img src="<?php echo w_icons("users_2");?>"/></span><span class="menu-item">Following</span></a>
...
echo ' </ul>
		...
		<a href="#"><span class="m-icon"><img src="'.w_icons("refresh_4").'"/></span><span class="menu-item">More following</span></a>
		<ul class="acitem">';
}
$i_f++;
}
...
if (mysql_num_rows($fresult) > 0) { ?>	
		...
		<li class="expand">
		<a href="#" class="active"><span class="m-icon"><img src="<?php echo w_icons("users_2");?>"/></span><span class="menu-item">Followers</span></a>
		<ul class="acitem" style="display: block; ">
<?php
$f_f = 1;
