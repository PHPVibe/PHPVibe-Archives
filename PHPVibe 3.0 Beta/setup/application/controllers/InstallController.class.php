...
class MK_InstallController extends MK_DefaultController{
	...
	public function sectionIndex(){
		...
		$messages[] = new MK_Message( (is_writable('../app/config.ini.php') ? 'success' : 'warning'), 'The permissions of file "<strong>admin/config.ini.php</strong>" set to <strong>0777</strong>' );
