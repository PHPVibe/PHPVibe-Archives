...
class MK_InstallController extends MK_DefaultController{
	...
	public function sectionIndex(){
		...
		$messages[] = new MK_Message( (is_writable('../uploads/playlists') ? 'success' : 'warning'), 'The permissions of folder "<strong>../uploads/playlists</strong>" set to <strong>0777</strong>' );
		...
		$messages[] = new MK_Message( (is_writable('../cache/feeds') ? 'success' : 'warning'), 'The permissions of folder "<strong>../cache/feeds</strong>" set to <strong>0777</strong>' );
		...
		$messages[] = new MK_Message( (is_writable('config.ini.php') ? 'success' : 'warning'), 'The permissions of file "<strong>admin/config.ini.php</strong>" set to <strong>0777</strong>' );
		...
		foreach($handle as $filefolder) {
			if($filefolder!='.' && $filefolder!='..' && is_dir('resources/components/'.$filefolder)){
				...
				if($component_details['core']){
					...
					$components_optional['checked'] = 'checked';
				}
			}
		}
