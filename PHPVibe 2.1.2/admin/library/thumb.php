...
require_once 'com/frame/File/File.class.php';
require_once 'com/frame/File/Image.class.php';
require_once 'com/frame/File/ImageThumb.class.php';
...
$image = new MK_Image_Thumb($file, $w, $h, $method, '../../uploads/');
